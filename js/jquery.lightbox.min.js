...
b.extend(b.LightboxClass.prototype,{images:[],constructed:false,compressed:null,src:null,baseurl:null,files:{compressed:{scripts:{lightbox:"scripts/jquery.lightbox.min.js",colorBlend:"scripts/jquery.color.min.js"},styles:{lightbox:"styles/jquery.lightbox.min.css"}},uncompressed:{scripts:{lightbox:"scripts/jquery.lightbox.js",colorBlend:"scripts/jquery.color.js"},styles:{lightbox:"styles/jquery.lightbox.css"}},images:{prev:"/i/box_nav/prev.gif",next:"/i/box_nav/next.gif",blank:"/i/box_nav/blank.gif",loading:"/i/box_nav/loading.gif"}},
text:{image:"Фотография",of:"из",close:"Закрыть X",closeInfo:"Вы можете нажать в любом месте вне картинки для её закрытия.",download:"Download.",help:{close:"Кликните для закрытия",interact:"Наведите курсор для взаимодействия"},about:{text:"",title:"",link:""}},keys:{close:"c",prev:"p",next:"n"},handlers:{show:null},opacity:0.9,padding:null,speed:400,rel:"lightbox",auto_relify:true,auto_scroll:"follow",
